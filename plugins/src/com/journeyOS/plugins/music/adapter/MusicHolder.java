...
public class MusicHolder extends BaseViewHolder<MusicInfoData> {

    @BindView(R2.id.app_item)
    SettingView mView;

    MusicInfoData mInfoData;

    public MusicHolder(View itemView, BaseRecyclerAdapter baseRecyclerAdapter) {
        super(itemView, baseRecyclerAdapter);
    }

    @Override
    public void updateItem(MusicInfoData data, int position) {
        mInfoData = data;
    ...
    void listenerSwitch() {
        ...
        msg.what = Messages.MSG_ADD_GESTURE_MUSIC;
        msg.obj = mInfoData;
