...
package com.journeyOS.barrage.model;
...
public class BarrageModel implements OnBarrageViewTouchListener {
    ...
    private OnBarrageTouchListener onTouchCallBackListener;
    ...
    public OnBarrageTouchListener getOnTouchCallBackListener() {
        return this.onTouchCallBackListener;
    }

    public void setOnTouchCallBackListener(OnBarrageTouchListener onTouchCallBackListener) {
