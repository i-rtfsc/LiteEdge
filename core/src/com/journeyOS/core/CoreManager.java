...
public class CoreManager {
    ...
    private static final Singleton<CoreManager> gDefault = new Singleton<CoreManager>() {
        @Override
        protected CoreManager create() {
    ...
    public <T extends ICoreApi> T getImpl(Class<T> api) {
