...
@Database(entities = {Edge.class, Ball.class, City.class, Weather.class, User.class, App.class, EdgeLab.class, Gesture.class, Music.class}, version = DBConfigs.DB_VERSION, exportSchema = false)
