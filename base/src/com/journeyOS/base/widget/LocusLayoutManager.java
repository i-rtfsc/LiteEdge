 ...
 * trajectory.
 */
public class LocusLayoutManager extends LinearLayoutManager {

    private static final int MIN_RADIUS = 0;
    private static final int MIN_PEEK = 0;

    /**
     * Valid gravity settings for a {@link LocusLayoutManager}.  This defines the direction of the center point
    ...
    /**
     * Define a new {@link LocusLayoutManager} with the given settings.<br>
     ...
     */
    public LocusLayoutManager(Context context,
                              @Gravity int gravity,
    ...
    /**
     * Create a {@link LocusLayoutManager} with default settings for gravity, orientation, and rotation.
     */
    public LocusLayoutManager(Context context,
                              @Dimension int radius,
                              @Dimension int peekDistance) {
