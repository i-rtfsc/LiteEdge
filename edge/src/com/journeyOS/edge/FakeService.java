...
public class FakeService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        LogUtils.d(TAG, "fake service create");
        startForeground(NotificationUtils.NOTIFICATION_ID, NotificationUtils.getNotification(getApplicationContext()));
        stopForeground(true);
        stopSelf();
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        LogUtils.d(TAG, "fake service destroy");
    }
}
